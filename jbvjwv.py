...
image = load_image(choose_file())
print("You will be prompted to input three colours for your tones. The\
available colours are:\n\tblack\n\twhite\n\tblood\n\tgreen\n\tblue\n\tlemon\n\t\
cyan\n\tmagenta\n\tgray\nPlease input your selected colours exactly as\
displayed above.")
input_tone_1 = input("Tone 1: ")
input_tone_2 = input("Tone 2: ")
input_tone_3 = input("Tone 3: ")
show(three_tone(image, input_tone_1, input_tone_2, input_tone_3))
...
# Main script-------------------------------------------------------------------
image = load_image(choose_file())
input_col = input("You will be prompted to a colour for your line. The \
available colours are:\n\tblack\n\twhite\n\tblood\n\tgreen\n\tblue\n\tlemon\n\t\
cyan\n\tmagenta\n\tgray\nPlease input your selected colour exactly as\
displayed above:\n") # user selects a colour for their curve
new_tuple = () # since the draw_curve return type is a tuple
new_tuple = draw_curve(image, input_col)
new_image = new_tuple[0] # image w/ filter is stored in new_tuple[0]
print("The curve crosses a horizontal border at pixel",new_tuple[1]) # POI
show(new_image)
